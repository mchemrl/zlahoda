...
export default function CategoriesPage() {
    ...
    const handleSaveChanges = () => {
        ...
        fetch(`http://localhost:5000/api/categories/?category_id=${selectedCategory.id}`, {
            method: "PUT",
    ...
    return (
        <div className="w-screen h-screen bg-[#fff3ea] font-['Kumbh_Sans'] text-lg font-normal flex flex-col relative">
            <header
                className="w-screen h-24 bg-[#f57b20] bg-opacity-75 shadow-lg flex justify-between items-center px-6">
